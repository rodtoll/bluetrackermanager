...
public class Constants {
    public static final String READINGS_ENTITY_NAME = "reading";
    public static final String READINGS_ENTITY_ID_PROPERTY = "id";
    public static final String READINGS_ENTITY_TIMESTAMP_PROPERTY = "timestamp";
